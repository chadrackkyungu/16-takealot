...
// !let use the profetional way the fetch the ID  from the URL

export const getStaticProps = async (context) => {
  // or => getServerSideProps
  const response = await fetch(
    // ! go to this => link bellow and grab the id that was clicked [context.params.id] then pass it as the props so that i can acces it
